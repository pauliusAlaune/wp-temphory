...
function theme_scripts(){
    ...
    if ( !is_admin() ) {
        ...
        wp_register_script('js_main', ASSETS_URL . '/assets/js/index.js', array('jquery', 'bootstrap'), '1.0', true);
...
function theme_stylesheets(){
	...
	if( $styles_path ) {
        wp_register_style('normalize', ASSETS_URL . '/assets/css/normalize.css', array(), false, 'all');
        wp_register_style('bootstrap', ASSETS_URL . '/assets/css/bootstrap.min.css', array(), false, 'all');
        wp_register_style('font_awesome', '//cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css', array(), false, 'all');
        wp_register_style('google_font', '//fonts.googleapis.com/css?family=Rajdhani:300,400,500,600,700', array(), false, 'all');
        
	
		wp_register_style('main-css', ASSETS_URL . '/assets/css/style.css', array('normalize', 'bootstrap', 'font_awesome', 'google_font'), false, 'all');
...
function navbar_menu($menu, $classes) {
    wp_nav_menu(array(
        'menu' => $menu,
        'theme_location' => $menu,
        'container' => '<ul></ul>',
